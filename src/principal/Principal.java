...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Metodos examen = new Metodos();
		char ejercicio1 = examen.metodo1(44749032);
		System.out.println("la letra es: " + ejercicio1);
		
		//EJERCICIO 2
		
		String[] libros = {"2#EL QUIJOTE DE LA MANCHA#16.25",
						   "X#LOS PILARES DE LA TIERRA#18.50",
						   "2#ODISEA EN EL ESPACIO#16.X",
						   "5#LOS PILARES DE LA TIERRA#18.50"};
		Libro[] ejercicio2 = examen.metodo(libros);
		
		//EJERCICIO 3
		
		int[][] ejercicio3 = examen.metodo3(3, 10);
